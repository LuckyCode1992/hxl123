...
import fuzik.com.myapplication.fragment_activity_demo.fragment_formwork.FragmentContainerHelper;
...
public class FixedFragmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fixed_fragment);
    ...
    private void initMagicIndicator4() {
        ...
        titleContainer.setDividerDrawable(new ColorDrawable() {
            ...
            public int getIntrinsicWidth() {
                return UIUtil.dip2px(FixedFragmentActivity.this, 15);
            }
        });
